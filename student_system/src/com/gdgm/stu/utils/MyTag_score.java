...
//成绩管理的页面跳转
public class MyTag_score extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			"stu_score.html?type=上一页&grade_name="+p.getGrade_name()+
			...
			out.print("<li><a href=" + 
		"stu_score.html?type=下一页&grade_name="+p.getGrade_name()+
		"&class_name="+p.getClass_name()+
		"&student_name="+p.getStudent_name()+"&student_no="+p.getStudent_no() +
		"&student_year="+p.getStudent_year() +
					">下一页</a></li>");
			...
			out.print("<li><a href=" + 
					"stu_score.html?type=首页&grade_name="+p.getGrade_name()+
					"&class_name="+p.getClass_name()+
					"&student_name="+p.getStudent_name()+"&student_no="+p.getStudent_no() +
					"&student_year="+p.getStudent_year() +
								">首页</a></li>");
			...
			out.print("<li><a href=" + 
					"stu_score.html?type=尾页&grade_name="+p.getGrade_name()+
					"&class_name="+p.getClass_name()+
					"&student_name="+p.getStudent_name()+"&student_no="+p.getStudent_no() +
					"&student_year="+p.getStudent_year() +
								">尾页</a></li></div>");
