	...
	<div class="container">
	   ...
	   <div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="myself3.html"  class="active"><i
	   ...
	   <div id="page-wrapper">
			...
			<table  class="table table-bordered table-striped">
		      ...
		      <tr><td>职能：</td><td>软件工程师</td></tr>
		      <tr><td>职位方向：</td><td>编程方向</td></tr>
		      <tr><td>工作地点：</td><td>广州</td></tr>
		      <tr><td>行业：</td><td>计算机软件</td></tr>
		      <tr><td>期待薪资：</td><td>4000-5000元/月 （包吃住3000-5000元/月）</td></tr>
		      <tr><td>到岗时间：</td><td>随时</td></tr>
		      <tr><td>工作类型：</td><td>全职</td></tr>
