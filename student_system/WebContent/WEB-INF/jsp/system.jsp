	  ...
	  <div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="student.html" method="get">
						<div class="form-group">
							<label for="customerName">级别名称：</label> 
					...
					<form class="form-inline" action="student.html" method="get">
						<div class="form-group">
							...
							<label for="customerName">级别编号：</label> 
							<input type="text" class="form-control" id="customerName" value="${return_type.student_no }" name="student_no">
						</div>
		...
		<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="student.html" method="get">
						<div class="form-group">
							<label for="customerName">班别名称：</label> 
							<select	class="form-control" name="grade_name">
								<option value="请选择">请选择</option>
							    <c:forEach items="${grade_type}" var="item">
							    	<option value="${item.grade_name}" <c:if test="${item.grade_name == return_type.grade_name}"> selected</c:if>>${item.grade_name}</option>
					...
					<form class="form-inline" action="student.html" method="get">
						<div class="form-group">
							<label for="customerName">班别名称：</label> 
							<input type="text" class="form-control" id="customerName" value="${return_type.student_no }" name="student_no">
							<label for="customerName">班别编号：</label> 
							<input type="text" class="form-control" id="customerName" value="${return_type.student_no }" name="student_no">
						</div>
						<button type="submit" class="btn btn-primary">添加</button>
					</form><br />
	   ...
	   <div class="row">
		...
		<table class="table table-bordered table-striped">
			<tr>
			    <td style="text-align: center">访问时间</td>
				<td style="text-align: center">IP地址</td>
				<td style="text-align: center">访问者</td>
			</tr>
			
			<c:forEach items="${ip}" var="item">
					<tr>
					    <td style="text-align: center">${item.visit_date}</td>
						<td style="text-align: center">${item.visit_ip}</td>
						<td style="text-align: center">${item.visitors}</td>
					</tr>
			</c:forEach>
