	...
	<div class="container">
	   ...
	   <div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					<li><a href="myself1.html" class="active"><i
	   ...
	   <div id="page-wrapper">
			...
			<table  class="table table-bordered table-striped">
		        <tr>
		          <td><img src="CSS/images/a.jpg" style="width:120px;height:120px"/></td>
		          <td>
		            <table>
		              <tr><td>赵汝涛</td></tr>
		              <tr><td>男22岁(1997/06/01)</td></tr>
		              <tr><td>未婚|一年经验</td></tr>
		            </table>
		          </td>
		        </tr>
		        ...
		        <tr>
		          <td>邮箱：</td>
		          <td>1585240709@qq.com</td>
		        </tr>
		        <tr>
		          <td>居住地：</td>
		          <td>广州白云嘉禾街望岗松盛四巷2号（合租，会根据工作地方修改住处）</td>
		        </tr>
		      </table>
